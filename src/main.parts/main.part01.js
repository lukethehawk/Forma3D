...
const staticTranslations = {
  en: {
    ...
    Chiudi: 'Close',
    'Annulla modifica (Ctrl+Z)': 'Undo (Ctrl+Z)',
    'Rifai (Ctrl+Y / Ctrl+Shift+Z)': 'Redo (Ctrl+Y / Ctrl+Shift+Z)',
    'Modifica': 'Change',
    ...
    'Canc elimina selezione o anteprima. Ctrl+Z annulla la modifica, Ctrl+Y o Ctrl+Shift+Z rifai.': 'Delete removes the selection or preview. Ctrl+Z undoes, Ctrl+Y or Ctrl+Shift+Z redoes.',
    ...
    'Passaggio cronologia applicato.': 'History step applied.',
    Lunghezza: 'Length',
